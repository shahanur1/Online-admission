...
//     header('location:signupconfirm.php');
  ...
  {
      $con = mysqli_connect("localhost", "root", "", "oas");
      $rs  = mysqli_query($con,"select CONCAT('STU',LPAD(RIGHT(ifnull(max(s_id),'STU00000'),5) + 1,5,'0')) from t_user_data");
             ...
             <div id="drig">
                 ...
                 <center><font style="color: #3399ff; margin-left:30px; font-family: Verdana;font-size:20px;">
                     <?php  //require_once("mail-content.php");  ?>
                      ...
                      <?php echo "Your Student ID is $stid and Password is $stpw" ; ?><br>
                    You are successfully registered. Please check your email ID or Phone for Student ID and Password. </font></center>
                 <br><br>
