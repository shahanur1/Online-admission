...
<head>
        ...
        <link type="text/css" rel="stylesheet" href="admsnform_files/admform.css">
         <script language="javascript" type="text/javascript" src="admsnform_files/jquery-1.js"></script>
     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <a href="index.html"><img src="admsnform_files/cutm.jpg" style="box-shadow: 1px 5px 14px #999999; " width="100%"></a>
                  </div>
                 </div>    
             </div>
            ...
            <br><table class="frmtbl">
                
                <tbody><tr border="1" class="hdrow">
                  ...
                  <tr>
                    ...
                    <td colspan="3"> <input type="text" id="uphn1" name="uphn1" required="true" vt="PH">
                  </td></tr>
                ...
                <tr>
                    <td><font style="font-family: Verdana;"> Income of Parents </font>
                     </td><td colspan="3"><input type="text" id="inc" name="inc" required="true"></td>
                </tr>
                
                <tr>
                    <td> <font style="font-family: Verdana;">Sex </font>
                    </td><td><input type="radio" id="gen" name="gen" value="Male"><font style="font-family: Verdana;">Male</font>
                ...
                <tr>
                    ...
                    </td><td><input type="text" id="natn" name="natn" required="true"></td>
                    <td><font style="font-family: Verdana;"> Religion</font>
                    </td><td><input type="text" id="relg" name="relg" required="true"></td>
                </tr> 
