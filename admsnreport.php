    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <center><font style="font-family:Verdana; font-size:18px;">
                    Phone : (+88)01963 686 929, Email : edtechbd@gmail.com
                    </font></center>
                
                <br>
                <br>
                <center><font style="font-family:Arial Black; font-size:20px;">
                    ADMISSIONS FROM</font></center>
                </td>
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo 'Address :'. $row[12] ?><br>
                          <?php echo 'District :'. $row[13] ?><br>
                          <?php echo 'Thana :'. $row[14] ?><br>
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo 'Address :'. $row[16] ?><br>
                          <?php echo 'District :'. $row[17] ?><br>
                          <?php echo 'Thana :'. $row[18] ?><br>
                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           <thead>
                            ...
                            <tbody>
                           <tr>
                               <td><?php echo "A level/SSC/Dakhil"; ?></td>
                           ...
                           <tr>
                               <td><?php echo "O level/Diploma/HSC/Alim"; ?> </td>
        ...
        ?>
             ...
             <a href="logout.php">Home</a></center>
    </body>
</html>
