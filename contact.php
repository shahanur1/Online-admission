            ...
            <li><a href="admissions.html">Admission</a></li>           
             <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="https://www.ets.org/gre/revised_general/register/">GRE</a></li>
                ...
                <div>
                  ...
                  <div class="contactform">                  
                    <form action="process.php" method="post">
                      ...
                      <p>Email</p>
                      <input type="email" name="Email" placeholder="example@email.com" class="form-control mb-2">
                      <p>Phone Number</p>
                      <input type="text" name="num" placeholder="01xxx-xxxxxx" class="form-control mb-2">
                      <p>Subject</p>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="mu-footer-widget">
                ...
                <ul>
                  ...
                  <li><a href="course-detail.html">IELTS ACADEMIC</a></li>
                  <li><a href="course.html">IELTS GENARAL</a></li>                  
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3">
